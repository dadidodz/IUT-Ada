pragma Ada_95;
pragma Warnings (Off);
pragma Source_File_Name (ada_main, Spec_File_Name => "b~distributeurboissons.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~distributeurboissons.adb");
...
package body ada_main is
   ...
   E142 : Short_Integer; pragma Import (Ada, E142, "distributeurutilities_E");
   ...
   begin
      ...
      E086 := E086 + 1;
      Distributeurutilities'Elab_Spec;
      E142 := E142 + 1;
   end adainit;

   procedure Ada_Main_Program;
   pragma Import (Ada, Ada_Main_Program, "_ada_distributeurboissons");
...
--  BEGIN Object file/option list
   --   .\distributeurutilities.o
   --   .\distributeurboissons.o
   --   -L.\
