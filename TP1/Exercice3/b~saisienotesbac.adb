pragma Ada_95;
pragma Warnings (Off);
pragma Source_File_Name (ada_main, Spec_File_Name => "b~saisienotesbac.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~saisienotesbac.adb");
...
package body ada_main is
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_saisienotesbac");
