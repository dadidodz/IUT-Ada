...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_calcultarifcalendriers" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#3d56af40#;
   pragma Export (C, u00001, "calcultarifcalendriersB");
   ...
   u00141 : constant Version_32 := 16#ee101ba4#;
   pragma Export (C, u00141, "system__memoryB");
   u00142 : constant Version_32 := 16#74d8f60c#;
