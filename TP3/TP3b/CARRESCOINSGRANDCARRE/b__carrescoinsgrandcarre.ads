...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_carrescoinsgrandcarre" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#3e4326c3#;
   pragma Export (C, u00001, "carrescoinsgrandcarreB");
